...
const WorkPlanFilterBlockMobile = (props) => {
    const {
        startDateRange,
        endDateRange,
        userWidth,
    ...
    const deleteAllFilters = () => {
        setStartDateRange(format(new Date(), 'yyyy-MM-dd'));
        setEndDateRange(format(new Date(), 'yyyy-MM-dd'));
        setDate(new Date());
        setDateRange([
            {
                startDate: new Date(),
    ...
    return (
        <OutsideClickHandler
            ...
            <Menu className={"work-plan-mobile-filter"}
                  overlayClassName={"work-plan-mobile-filter-overlay"}
                  menuClassName={"work-plan-mobile-filter-menu"}
                  ...
                  disableCloseOnEsc>
                <div>
                    <div className="work-plan-mobile-filter-header">
                        <div className="work-plan-mobile-apply-button"
                             onClick={applyAllFilters}>Применить
                        </div>
                        <div className="work-plan-mobile-delete-button"
...
WorkPlanFilterBlockMobile.propTypes = {
...
const mapStateToProps = ({workPlanReducer}) => ({
    ...
    filterShow: workPlanReducer.filterShow,
